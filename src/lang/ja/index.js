...
export default {
   ...
   fullScreen: '全画面表示',
   ecommerce: '電子商取引',
   shopWithAlgolia: 'Algoliaで買い物をする',
   cart: 'カート',
   total: '合計',
   totalPrice: '合計金額',
   viewCart: 'かごの中身を見る',
   ...
   duration:"期間",
   netWorth:"純資産",
   liveChatSupport:"ライブチャットのサポート",
   marketCap:"時価総額",
   wallet:"財布",

   budget:"予算",
   department:"部門",
   projectManager:"プロジェクトマネージャ",
   team:"チーム",  
   status:"状態",
   deadline:"締め切り",
   ...
   fileInput:"ファイル入力",
   colorPickers:"カラーピッカー",
   size:"サイズ",
   validation:"検証",
   playground:"遊び場",
   chipGroups:"チップグループ",
   overlays:"オーバーレイ",
   slideGroups:"スライドグループ",
   simpleTable:"シンプルなテーブル",
   listItemGroups:"リストアイテムグループ",
   banners: "バナー",
   appBars: "アプリバー"
}

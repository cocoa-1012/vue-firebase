...
export default {
  ...
  shopWithAlgolia: 'Vásároljon Algolia-val',
  cart: 'kocsi',
  total: 'Teljes',
  ...
  procedureDetail:"Tanfolyamok Részletesen",
  ...
  currenciesAvailable:"Elérhető pénznemek",
  receivedAmount:"Fogadott összeg",
  sentAmount:"Elküldött összeg",
  totalAmount:"Teljes összeg",
  walletAddress:"Mobiltárca címe",
  withdraw:"visszavonul",
  deposit:"Letét",
  bankDetails:"Banki adatok",
  phone :"Telefon",
  account :"számla",
  buyCryptocurrency:"Vásárlás Cryptocurrency",
  expenditureStats:"Kiadási statisztika",
  sellCryptocurrency:"Eladni Cryptocurrency",
  transferCryptocurrency:"Cryptocurrency átvitele",
  buyOrSell:"megvesz / Elad",
  crm:"CRM",
  crypto:"Crypto",
  supervisor:"Felügyelő",
  duration:"tartam",
  netWorth:"Nettó érték",
  liveChatSupport:"Live Chat támogatás",
  marketCap:"Piaci sapka",
  wallet:"Pénztárca",

  budget:"Költségvetés",
  department:"Osztály",
  projectManager:"Projekt menedzser",
  team:"Csapat",  
  status:"Állapot",
  deadline:"Határidő",
  ...
  shop :"Üzlet",
  productDetail :"Termék leírás",
  addProduct :"Termék hozzáadása",
  editProduct :"Termék szerkesztése",
  editDetail :"Részletek szerkesztése",
  
  fileInput:"Fájlbevitel",
  colorPickers:"Színválasztók",
  size:"Méret",
  validation:"Érvényesítés",
  playground:"Játszótér",
  chipGroups:"Chip csoportok",
  overlays:"lefedések",
  slideGroups:"Diacsoportok",
  simpleTable:"Egyszerű táblázat",
  listItemGroups:"Tételcsoportok felsorolása",
  banners: "Reklám",
  appBars: "Alkalmazási sáv"
}

      ...
      },
      {
      ...
      },
		{
			...
			items: [
				...
				{ title: 'message.procedureDetail', path: '/courses/courses-detail',label: 'Old' },
		...
		},
		{
			...
			label: 'Old',
			items: [
				{ title: 'message.signUp', path: '/sign-up', exact: true ,label: 'Old'},
				{ title: 'message.login', path: '/login', exact: true,label: 'Old' },
				{ title: 'message.lockScreen', path: '/lock-screen', exact: true ,label: 'Old'},
				{ title: 'message.forgotPassword', path: '/forgot-password', exact: true ,label: 'Old'},
				{ title: 'message.resetPassword', path: '/reset-password', exact: true ,label: 'Old'}
			]
		}
	],
	'message.modules': [

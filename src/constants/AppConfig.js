...
export default {
	...
	appLogo2: '/static/img/logo-proceed.png',                                    // App Logo 2 For Login & Signup Page
	brand: 'Proceed',                                        			        // Brand Name
	copyrightText: 'Proceed © 2020 All Rights Reserved.',                     // Copyright Text

<template>
  <div>
    ...
    <v-container grid-list-xl pt-0>
      <v-row>
        <app-card
          :heading="$t('message.appBars')"
          customClasses="mb-30"
          colClasses="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
        >
          <div class="mb-5">
            <p>
              The <code>v-app-bar</code> component is pivotal to any graphical
              user interface (GUI), as it generally is the primary source of
              site navigation.
            </p>
          </div>
        ...
        >
          <v-row justify="center">
            ...
            <v-col cols="6" md="3" lg="2">
              <v-switch v-model="collapse" label="Collapse"></v-switch>
            </v-col>
            <v-col cols="6" md="3" lg="2">
              <v-switch

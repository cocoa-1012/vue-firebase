  ...
  <app-card class="course-detail-billing-wrap cpb-24">
    <div class="price-wrap">
      ...
      <span class="cmr-8 base-price d-inline-block"
        ><del
          >${{ CourseData.CourseDetail.billingDetails.totalPrice }}</del
        ></span
      >
      <span class="discount-value d-inline-block"
        >{{ CourseData.CourseDetail.billingDetails.discountPercent }} %
        off</span
      >
    </div>
    ...
    <div class="button-wrap">
      ...
      <p class="text-center">
        {{ CourseData.CourseDetail.billingDetails.guarntee }}day money back
        garuntee
      </p>
    </div>
    <div class="incentives">
      ...
      <v-list
        ...
        v-for="(feature, key) of CourseData.CourseDetail.billingDetails
          .includes"
        :key="key"
      >
        <v-list-item>

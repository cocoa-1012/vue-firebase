          ...
          <div class="courses-grid-sec">
            <v-row class="custom-align-stretch fill-heigh course-grid-layout">
              ...
              <app-card
                :fullScreen="true"
                :closeable="true"
                colClasses="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8"
              ...
              >
                <v-tabs v-if="CourseData.courses" slider-color="primary">
                  <v-tab
                    v-if="
                      CourseData.courses.type == CourseData.courses.management
                    "
                    ripple
                  >
                  ...
                  <v-tab
                    v-if="
                      CourseData.courses.type == CourseData.courses.development
                    "
                    ripple
                  >
                ...
                <div class="view-all-link">
                  <router-link
                    :to="`/${
                      getCurrentAppLayoutHandler() + '/courses/courses-list'
                    }`"
                    >View All
                  </router-link>
                </div>
              ...
              <v-col sm="12" s="12" md="12" lg="12" xl="12">
                <div class="popularity tab-wrap">
                  <v-tabs v-if="CourseData.courses" slider-color="primary">
                    <v-tab
                      v-if="
                        CourseData.courses.popular == CourseData.courses.top
                      "
                      ripple
                    >
                      {{ $t("message.top") }}
                    ...
                    <v-tab
                      v-if="
                        CourseData.courses.popular == CourseData.courses.new
                      "
                      ripple
                    >
                      {{ $t("message.new") }}
                    ...
                    <v-tab
                      v-if="
                        CourseData.courses.popular ==
                        CourseData.courses.trending
                      "
                      ripple
                    >
                      {{ $t("message.trending") }}
...
<script>
import CourseBanner from "./ProcedureWidgets/ProcedureBanner";
//import InstructorCard from "./proceed/ProcedureWidgets/InstructorCard";
import CourseData from "./data";
import CourseCard from "./ProcedureWidgets/ProcedureCard";

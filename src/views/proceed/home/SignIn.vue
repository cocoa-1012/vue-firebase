        ...
        <v-col cols="12" sm="12" md="10" lg="10" xl="9">
          <div class="shop-by-category section-gap pad-y-lg">
            <v-row class="justify-center">
              <v-col cols="12" sm="8" md="6" lg="6" xl="6">
                ...
                >
                  <v-form>
                    ...
                    <v-btn color="error" class="danger mx-0 mb-5" to="/login">{{
                      $t("message.signIn")
                    }}</v-btn>
                    <p>
                      Don't have an account?
                      <router-link to="/session/sign-up" class="primary-text"
              ...
              <v-col cols="12" sm="8" md="6" lg="6" xl="6">
                <app-card
                  :heading="$t('message.guestCheckout')"
                  contentCustomClass="pt-0"
                >
                  ...
                  <v-btn
                    class="error mx-0"
                    :to="`/${
                      getCurrentAppLayoutHandler() + '/courses/payment'
                    }`"
...
<script>
import CourseBanner from "./proceed/ProcedureWidgets/ProcedureBanner";

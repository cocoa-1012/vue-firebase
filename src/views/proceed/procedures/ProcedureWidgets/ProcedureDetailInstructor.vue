<template>
  <app-card
    ...
    v-if="CourseData.procedureDetail"
  ...
  >
    <div class="d-flex align-center justify-start mx-0 mt-0 mb-4">
      <div class="image-wrap mb-2">
        <img :src="CourseData.procedureDetail.instructorInformation.image" />
      </div>
      <div class="instructor-meta">
        <h4>{{ CourseData.procedureDetail.instructorInformation.name }}</h4>
        <v-list
          class="incentive-list"
          v-for="(feature, key) of CourseData.procedureDetail
            .instructorInformation.features"
          :key="key"
        >
    ...
    <p>{{ CourseData.procedureDetail.instructorInformation.content }}</p>
  </app-card>
</template>

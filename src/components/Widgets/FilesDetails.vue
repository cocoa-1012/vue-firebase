  ...
  <div class="contact-tab-wrapper">
    <v-tabs v-model="active" slider-color="primary">
      ...
      <v-tab-item>
        ...
        <v-row>
          <template v-for="(details, index) in clientData.Clients">
            <app-card
              v-if="details.tag == 'activities' || 'procedure'"
              :id="index"
            ...
            >
              <v-row class="contact-item-info">
                ...
                <v-col cols="12" md="12" class="text-center pt-0">
                  ...
                  <span class="d-block text-ellipse contact-links font-sm"
                    ><a
                      href="mailto:JerryBRied@jourrapide.com"
                      class="grey--text"
                      >{{ details.e_mail }}</a
                    ></span
                  >
                  <span class="d-block contact-links font-sm"
                    ><a class="grey--text" href="tel:+12075894752">{{
      ...
      <v-tab-item>
        <br />
        <v-row>
          <template v-for="(details, key) in clientData.Clients">
            <app-card
              v-if="details.tag == 'activities'"
              colClasses="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12"
              :key="key"
            >
              <v-row class="contact-item-info">
                <v-col cols="12" md="12" class="text-center">
                ...
                <v-col cols="12" md="12" class="text-center pt-0">
                  ...
                  >
                  <span class="d-block contact-links font-sm"
                    ><a href="tel:+12075894752" class="grey--text">{{
                      details.phone_number
                    }}</a></span
                  >
                  <span class="font-sm grey--text">{{ details.country }}</span>
        ...
        <v-card class="pa-6">
          ...
          <v-card-actions class="pa-0">
            ...
            <v-btn color="primary" @click="open = false" class="px-4"
              >Cancel</v-btn
            >
            <v-btn color="error" @click="editClientItem" class="px-4"
              >Update</v-btn
            >
          </v-card-actions>
        </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      editLocation: "",
      tabHead: [
        { key: "all", tab_name: "AllFiles" },
        { key: "activities", tab_name: "activities" },
        { key: "procedure", tab_name: "procedure" },
      ],
    };
  },
  methods: {

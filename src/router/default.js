...
//onst Ecommerce = () => import('Views/dashboard/Ecommerce');
...
// Proceed Home
const ProceedList = () => import('Views/proceed/procedures/List');
//const ProceedDetail = () => import('Views/proceed/procedures/Details');
const ProceedMaster = () => import('Views/proceed/procedures/Master');

const ProceedIdentify = () => import('Views/proceed/procedures/Identify');
const ProceedProcess = () => import('Views/proceed/procedures/Process');
const ProceedAttachments = () => import('Views/proceed/procedures/Attachments');
const ProceedAccess = () => import('Views/proceed/procedures/Access');
/* 
const ProceedNew = () => import('Views/proceed/procedures/New');
const ProceedEdit = () => import('Views/proceed/procedures/Edit');
*/

const Proceed2Master = () => import('Views/proceed/procedures2/Master');
...
const privateUser = {
    ...
    //#PR1 - Página Dashboard Usuário
    { path: '/users/dashboard', component: User },
...
export default {
  ...
  children: [
    ...
    {
      path: '/procedures/new/',
      component: ProceedMaster,
      redirect: { name: 'NewProceedIdentify' },
      meta: {
        requiresAuth: true,
        title: 'New Procedure',
        breadcrumb: [
    ...
    {
      path: '/procedures/:slug/edit',
      component: ProceedMaster,
      name: 'ProceedMaster',
      redirect: { name: 'ProceedIdentify' },
      meta: {
        requiresAuth: true,
        title: 'message.projectDetails',
        breadcrumb: [
          {
            breadcrumbInactive: 'Procedures /'
          },
          {
      ...
      children: [
        {
          path: '/procedures/new#identify',
          name: 'NewProceedIdentify',
          component: ProceedIdentify,
        },
        {
          path: '/procedures/:slug/edit#identify',
          name: 'ProceedIdentify',
          component: ProceedIdentify,
        },
        {
          path: '/procedures/:slug/edit#process',
          name: 'ProceedProcess',
          component: ProceedProcess,
        },
        {
          path: '/procedures/:slug/edit/attachments',
          name: 'ProceedAttachments',
          component: ProceedAttachments,
        },
        {
          path: '/procedures/:slug/edit/access',
          name: 'ProceedAccess',
          component: ProceedAccess,
        },
      ]
    },

    {
      ...
      children: [
        {
          path: '/:username/:slug/edit/identify',
          name: 'ProceedIdentify',
          component: ProceedIdentify,
        },
        {
          path: '/:username/:slug/edit/process',
          name: 'ProceedProcess',
          component: ProceedProcess,
        },
        {
          path: '/:username/:slug/edit/attachments',
          name: 'ProceedAttachments',
          component: ProceedAttachments,
        },
        {
          path: '/:username/:slug/edit/access',
          name: 'ProceedAccess',
          component: ProceedAccess,
        },
      ]
    ...
    /*
          {
            ...
            children:[
              {
                path: '/procedures/:id/identify',
                name: 'ProceedIdentify',
                component: ProceedIdentify,
              },
              {
                path: '/procedures/:id/process',
                name: 'ProceedProcess',
                component: ProceedProcess,
              },
              {
                path: '/procedures/:id/attachments',
                name: 'ProceedAttachments',
                component: ProceedAttachments,
              },
              {
                path: '/procedures/:id/access',
                name: 'ProceedAccess',
                component: ProceedAccess,
              },
            ]
    ...
    
         {
          ...
          children:[
            ...
            {
              path: '/procedures/new/process',
              name: 'ProceedProcess',
              component: ProceedProcess,
            },
            {
              path: '/procedures/new/attachments',
              name: 'ProceedAttachments',
              component: ProceedAttachments,
            },
            {
              path: '/procedures/new/access',
              name: 'ProceedAccess',
              component: ProceedAccess,
            },
          ]
